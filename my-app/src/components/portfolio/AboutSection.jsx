        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <p className="text-lg text-[var(--text-muted)] leading-relaxed">
              ...
              creating innovative technology solutions. My journey spans from teaching coding to young minds 
              to building complex systems and founding my own streetwear brand.
            </p>
            
            <p className="text-lg text-[var(--text-muted)] leading-relaxed">
              What drives me is the intersection of creativity and technology. Whether I'm developing 
              a Unity game with procedural generation, building an RC car with unlimited range, 
              or optimizing data structures for better performance, I'm always looking for ways to 
              push boundaries and solve real-world problems.
            </p>

            <p className="text-lg text-[var(--text-muted)] leading-relaxed">
              My experience ranges from low-level hardware programming to high-level software architecture, 
              with a special interest in game development, embedded systems, and creating tools that 
              make complex tasks simple and elegant.
            </p>
          </div>
            ...
            {highlights.map((highlight, index) => (
              <Card key={index} className="border-none shadow-lg star-border">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-[var(--text-muted)] leading-relaxed">{highlight.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
