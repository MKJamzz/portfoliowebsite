...
export default function ExperienceSection() {
  ...
  return (
    <section id="experience" className="py-24 bg-[var(--background-alt)]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[var(--text-muted)] max-w-3xl mx-auto">
            From teaching the next generation of programmers to founding my own business, 
        ...
        <div className="space-y-8">
          {experiences.map((exp, index) => (
            <Card key={index} className="border-none shadow-lg star-border">
              <CardHeader className="pb-4">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="flex items-start gap-4">
                    <div className={`w-12 h-12 ${exp.color} rounded-xl flex items-center justify-center flex-shrink-0`}>
                    ...
                    <div>
                      ...
                      <div className="flex flex-col sm:flex-row gap-2 text-sm text-[var(--text-muted)]">
              ...
              <CardContent>
                <p className="text-[var(--text-muted)] mb-4 leading-relaxed">{exp.description}</p>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {exp.skills.map((skill, idx) => (
                      <Badge key={idx} variant="outline" className="bg-white hover:bg-slate-50 transition-colors">
                        {skill}
                      </Badge>
                    ))}
                  </div>
